...
@section('content')
 ...
 <title>
    Input Absen Senbud - Aplikasi Pemilihan Senbud UPD
 </title>
  ...
  <div class="container-fluid" style="margin-top:-60px !important;">
        ...
        <div class="card col-xl-4">
            <div class="card-body">
                <span class="mr-3" style="font-size:16px; font-weight:bold;">Input Absen Instruktur <br> Tanggal : <?php echo date('d-m-Y')?> <br> Nama Instruktur : {{$senbud->nama}} <br>  </span>
            </div>
        </div>
        <div class="card shadow mt-2">
            <div class="card-body">
            <div style="overflow-x:auto;">
            <form action="/input_absen_instruktur_senbud" method="POST">
            ...
            {{csrf_field()}}
            <input type="hidden" value="<?php echo date('Y-m-d')?> " name="tgl_absen_instruktur_senbud">
            <table id="example" class="table table-striped table-bordered nowrap mt-3 text-center" style="overflow-x:auto;">
                ...
                <tbody>
                    ...
                    <td class="align-middle name">{{$senbud->nama}}</td>
                    <td class="align-middle name">{{$senbud->email}}</td>
                    <td>
