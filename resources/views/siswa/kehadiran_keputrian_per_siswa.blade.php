...
<title>
    Data Keputrian {{$keputrian_siswa->nama_keputrian}}  - Aplikasi Pemilihan keputrian UPD
 </title>
<!-- Header -->
                ...
                <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data kehadiran Keputrian <span class="text-white" style="font-weight: bold">{{$keputrian_siswa->nama_keputrian}} </span></h5>
                                </div>
                                <div class="col-auto">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="{{url('/assets/img/database/'.$keputrian_siswa->foto)}}" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body">
                  <div style="overflow-x:auto;">
                      <table id="example" class="table table-striped table-bordered nowrap mt-3" style="overflow-x:auto;">
                        ...
                        <tbody>
                          @foreach($kehadiran_keputrian as $k)
                          <tr>
                              <td></td>
                              <td>{{$k->tgl_absen_keputrian_detail}}</td>
                              <td>{{$k->keterangan_absen_keputrian}}</td>
                          </tr>
                          @endforeach
                        </tfoot>
                      </table>
