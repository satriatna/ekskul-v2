...
<title>
    Data Senbud {{$senbud_siswa->nama_senbud}}  - Aplikasi Pemilihan Senbud UPD
 </title>
<!-- Header -->
                ...
                <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data kehadiran senbud <span class="text-white" style="font-weight: bold">{{$senbud_siswa->nama_senbud}} </span></h5>
                                </div>
                                <div class="col-auto">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="{{url('/assets/img/database/'.$senbud_siswa->foto)}}" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body">
                  <div style="overflow-x:auto;">
                      <table id="example" class="table table-striped table-bordered nowrap mt-3" style="overflow-x:auto;">
                        ...
                        <tbody>
                          @foreach($kehadiran_senbud as $k)
                          <tr>
                              <td></td>
                              <td>{{$k->tgl_absen_senbud_detail}}</td>
                              <td>{{$k->keterangan_absen_senbud}}</td>
                          </tr>
                          @endforeach
                        </tfoot>
                      </table>
