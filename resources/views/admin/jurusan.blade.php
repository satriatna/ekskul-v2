      ...
      <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data Jurusan </span></h5>
                                </div>
                                <div class="col-auto">
          ...
          <div class="card shadow">
            ...
            <table class="table table-striped table-bordered" id="example"  cellspacing="0" width="100%">
                ...
                <tr class="data-row">
                    ...
                    <td class="align-middle name">{{$r->nama_jurusan}} </td>
                    <td class="align-middle">
                    <a href="/jurusan/detail/{{$r->id_jurusan}}" class="btn btn-info btn-sm">Detail</a>
                    <button type="button" class="btn btn-primary btn-sm" id="edit-item" data-item-id="{{$r->id_jurusan}} ">Edit</button>
                    <!-- <a href="/jurusan/hapus/{{$r->id_jurusan}}" onclick="return confirm('Anda Yakin ?')" class="btn btn-danger btn-sm">Hapus</a> -->
                    </td>
                </tr>
                @endforeach
                </tbody>
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="edit-form" class="form-horizontal" method="POST" action="/jurusan/update">
         {{csrf_field()}}
                <input type="hidden" name="modal_input_id" class="form-control" id="modal_input_id" required>
              <!-- /id -->
              <!-- name -->
              <div class="form-group">
                <label class="col-form-label" for="modal_input_name">Nama Jurusan</label>
        ...
        {{csrf_field()}}
            <div class="form-group">
                ...
                @if ($errors->has('nama_jurusan'))
                    <div class="error">Gagal : Nama jurusan tersebut telah digunakan sebelumnya</div>
                @endif
            </div>
