...
@section('content')
<title>
    Data Siswa Senbud Alpa > 3 - Aplikasi Pemilihan Senbud UPD
</title>
      ...
      <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data Siswa Senbud Alpa > 3 <br>
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                ...
                                @else
                                <a href="/senbud_alpa_3_export" class="btn btn-primary btn-block">Export Excel</a>
                                @endif
          ...
          <div class="card shadow">
            ...
            <table class="table table-striped table-bordered" id="example" cellspacing="0" width="100%">
                ...
                <tr class="data-row">
                    ...
                    <td class="align-middle name">{{$u->nama_senbud}}</td>
                    <td class="align-middle name">{{$u->kehadiran_senbud}}</td>
                    <td><a href="/detail_siswa/{{$u->id}}" class="btn btn-sm btn-info">Lihat</a></td>
                </tr>
                @endforeach
                </tbody>
            </table>
