...
@section('content')
<title>
    Data Siswa Ekskul Produktif Alpa > 3 - Aplikasi Pemilihan Senbud UPD
</title>
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                ...
                                @else
                                <a href="/ekskul_produktif_alpa_3_export" class="btn btn-primary btn-block">Export Excel</a>
                                @endif
          ...
          <div class="card shadow">
            ...
            <table class="table table-striped table-bordered" id="example" cellspacing="0" width="100%">
                ...
                <tr class="data-row">
                    ...
                    <td class="align-middle name">{{$u->nama_ekskul_produktif}}</td>
                    <td class="align-middle name">{{$u->kehadiran_ekskul_produktif}}</td>
                </tr>
                @endforeach
                </tbody>
            </table>
