...
@section('content')
<title>
Data Detail Rombel - Aplikasi Pemilihan Senbud UPD
</title>
            ...
            <div class="col-xl-4 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0"> Data Siswa Rombel <br> @if($nama_rombel == '') @else {{$nama_rombel->nama_rombel}} @endif</h5>
                      </div>
                      <div class="col-auto">
          ...
          <div class="card">
            ...
            {{csrf_field()}}
              ...
              <label for="dari">Dari</label>
                <input type="text" class="form-control" value="{{$nama_rombel->nama_rombel}}" readonly>
                        <br>
