...
@section('content')
<title>
    Kehadiran Instruktur Ekskul Biasa {{$ekskul_biasa->nama_ekskul_biasa}}- Aplikasi Pemilihan ekskul_biasa UPD
</title>
        ...
        <div class="col-xl-4 mb-5 mb-xl-0">
            ...
            <div class="col-xl-8 mb-5 mb-xl-0">
                <div class="card shadow-lg">
                    ...
                    Ekskul Biasa <span style="font-weight: bold">( {{$ekskul_biasa->nama_ekskul_biasa}} )</span><a class="btn btn-primary btn-sm float-right" href="/kehadiran_instruktur_ekskul_biasa/{{$ekskul_biasa->id_ekskul_biasa}}">Lihat</a>
                    </div>
