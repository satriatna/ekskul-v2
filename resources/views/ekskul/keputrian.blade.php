      ...
      <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data Keputrian </span></h5>
                                </div>
                                <div class="col-auto">
            ...
            <table class="table table-striped table-bordered" id="example"  cellspacing="0" width="100%">
                ...
                <tr class="data-row">
                    ...
                    <td class="align-middle kuota">
                      ...
                      @else
                        <a href="/pengguna/detail/{{$s->instruktur_keputrian_id}}" class="btn btn-primary btn-sm">Lihat</a>
                      @endif
                    </td>
