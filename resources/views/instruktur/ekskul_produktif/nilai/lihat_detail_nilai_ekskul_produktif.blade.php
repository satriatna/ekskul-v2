...
@section('content')
 ...
 <title>
    Detail Nilai Siswa Ekskul Produktif {{$nama_ekskul_produktif->nama_ekskul_produktif}} - Aplikasi Pemilihan Senbud UPD
 </title>
      ...
      <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white"> Nilai Siswa Ekskul Produktif : {{$nama_ekskul_produktif->nama_ekskul_produktif}} <br> Keterangan : {{$ambil->keterangan_nilai_ekskul_produktif_detail}} </span></h5>
                                </div>
                                <div class="col-auto">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                ...
                                <a href="/export_nilai_ekskul_produktif/{{$ambil->keterangan_nilai_ekskul_produktif_detail}}" class="btn btn-primary btn-block">Export Excel
                  </a> 
                                </h5>
                                </div>
                                <div class="col-auto">
        ...
        <div class="col-xl-12 mb-5 mb-xl-0">
          <div class="card shadow">
            ...
            <table class="table table-striped table-bordered text-center" id="example"  cellspacing="0" width="100%">
                ...
                @foreach($tb_nilai_ekskul_produktif as $tb)
                <tr class="data-row">
                    ...
                    <td class="align-middle kuota">{{$tb->nilai_sikap_ekskul_produktif}}</td>
                    <td class="align-middle kuota">{{$tb->nilai_pengetahuan_ekskul_produktif}}</td>
                    <td class="align-middle kuota">
                        <form action="/nilai_ekskul_produktif_ubah" method="GET">
                            <input type="hidden" name="id_nilai_ekskul_produktif" value="{{$tb->id_nilai_ekskul_produktif}}">
                            <input type="hidden" name="users_nilai_ekskul_produktif_id" value="{{$tb->users_nilai_ekskul_produktif_id}}">
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit ekskul_produktif</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="edit-form" class="form-horizontal" method="POST" action="/ekskul_produktif/update">
         {{csrf_field()}}
                <input type="hidden" name="modal_input_id" class="form-control" id="modal_input_id" required>
              <!-- /id -->
              <!-- name -->
              <div class="form-group">
                <label class="col-form-label" for="modal_input_name">Nama ekskul_produktif</label>
                <input type="text" name="modal_input_name" class="form-control" id="modal_input_name" required autofocus>
              </div>
              <div class="form-group">
                <label class="col-form-label" for="modal_input_hari">Nama ekskul_produktif</label>
                <input type="text" name="modal_input_hari" class="form-control" id="modal_input_hari" required autofocus>
              </div>
              <div class="form-group">
                <label class="col-form-label" for="modal_input_kuota">Nama ekskul_produktif</label>
