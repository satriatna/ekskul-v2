      ...
      <div class="row">
         <div class="col-xl-5 order-xl-2">
          <div class="card geser">
              ...
              <div class="card-body">
                  <form method="POST" action="/data_kehadiran_senbud_ubah_post">
                  {{csrf_field()}}
                  <input type="hidden" name="id_absen_senbud" value="{{$siswa->id_absen_senbud}}">
                  <input type="hidden" name="senbud_id_absen" value="{{$siswa->senbud_id_absen}}">
                  <input type="hidden" name="tgl" value="{{$siswa->tgl_absen_senbud_detail}}">
