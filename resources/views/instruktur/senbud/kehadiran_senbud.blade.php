      ...
      <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data Kehadiran Senbud : {{$nama_senbud->nama_senbud}} </span></h5>
                                </div>
                                <div class="col-auto">
        ...
        <div class="col-xl-12 mb-5 mb-xl-0">
          <div class="card shadow">
            ...
            <table class="table table-striped table-bordered" id="example"  cellspacing="0" width="100%">
                ...
                @foreach($tgl_absen_senbud as $tgl)
                <tr class="data-row">
                    <td class="align-middle iteration">1</td>
                    <td class="align-middle kuota">{{$tgl->tgl_absen_senbud}}</td>
                    <td class="align-middle">
                    <a href="/kehadiran/senbud/detail/{{$tgl->tgl_absen_senbud}}/{{$tgl->tgl_absen_senbud_id}}" class="btn btn-info btn-sm">Detail</a>
                    <a href="/kehadiran/senbud/hapus/{{$tgl->tgl_absen_senbud}}" onclick="return confirm('Anda Yakin ?')" class="btn btn-danger btn-sm">Hapus</a>
                    </td>
                </tr>
                @endforeach
                </tbody>
