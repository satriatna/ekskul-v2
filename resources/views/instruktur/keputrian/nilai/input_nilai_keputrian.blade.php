...
@section('content')
 ...
 <title>
    Input Nilai Siswa Keputrian - Aplikasi Pemilihan Senbud UPD
 </title>
  ...
  <div class="container-fluid" style="margin-top:-60px !important;">
        ...
        <div class="card col-xl-6">
            <div class="card-body">
                <span class="mr-3" style="font-size:16px; font-weight:bold;">Input Nilai Keputrian </span>
            </div>
        </div>
        ...
        Data Nama Siswa 
            ...
            <form action="/input_nilai_keputrian_post" method="POST">
            ...
            <label for="keterangan_nilai_keputrian">Keterangan Nilai</label>
            <input type="text" name="keterangan_nilai_keputrian" class="form-control col-md-3" id="keterangan_nilai_keputrian" placeholder="Contoh : Semester 1" required>
            </div>
