...
@section('content')
 ...
 <title>
    Nilai Siswa Keputrian {{$nama_keputrian->nama_keputrian}} - Aplikasi Pemilihan Senbud UPD
 </title>
      ...
      <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data Nilai Siswa Keputrian : {{$nama_keputrian->nama_keputrian}} </span></h5>
                                </div>
                                <div class="col-auto">
        ...
        <div class="col-xl-12 mb-5 mb-xl-0">
          <div class="card shadow">
            ...
            <table class="table table-striped table-bordered text-center" id="example"  cellspacing="0" width="100%">
                ...
                @foreach($tb_keterangan_nilai_keputrian as $tb)
                <tr class="data-row">
                    <td class="align-middle iteration">1</td>
                    <td class="align-middle kuota">{{$tb->keterangan_nilai_keputrian}}</td>
                    <td class="align-middle kuota">{{$tb->tgl_nilai_keputrian}}</td>
                    <td class="align-middle">
                    <a href="/lihat_detail_nilai_keputrian/{{$tb->keterangan_nilai_keputrian}}" class="btn btn-info btn-sm">Detail</a>
                    <a href="/hapus_nilai_keputrian/{{$tb->id_keterangan_nilai_keputrian}}" onclick="return confirm('Anda Yakin ?')" class="btn btn-danger btn-sm">Hapus</a>
                    </td>
                </tr>
                @endforeach
                </tbody>
