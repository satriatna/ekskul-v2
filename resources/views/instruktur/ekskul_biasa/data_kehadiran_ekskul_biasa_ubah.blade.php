      ...
      <div class="row">
         <div class="col-xl-5 order-xl-2">
          <div class="card geser">
              ...
              <div class="card-body">
                  <form method="POST" action="/data_kehadiran_ekskul_biasa_ubah_post">
                  {{csrf_field()}}
                  <input type="hidden" name="id_absen_ekskul_biasa" value="{{$siswa->id_absen_ekskul_biasa}}">
                  <input type="hidden" name="ekskul_biasa_id_absen" value="{{$siswa->ekskul_biasa_id_absen}}">
                  <input type="hidden" name="tgl" value="{{$siswa->tgl_absen_ekskul_biasa_detail}}">
