...
use DB;
class KehadiranKeputrianExport implements FromCollection
{
    protected $id;
    ...
    */
    ...
    {
        return DB::table('tb_absen_keputrian')->where("tgl_absen_keputrian_detail",$this->id)->select('tgl_absen_keputrian_detail','keterangan_absen_keputrian','nis','nama','nama_jurusan','nama_rombel','nama_rayon','kelas','jk','nama_keputrian')
