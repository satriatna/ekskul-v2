...
use DB;
class DataKeputrianExport implements FromCollection
{
    protected $id;
    ...
    */
    ...
    {
        return DB::table('users')->where("keputrian_id",$this->id)->select('nis','nama','nama_jurusan','nama_rombel','nama_rayon','kelas','jk','nama_keputrian')
