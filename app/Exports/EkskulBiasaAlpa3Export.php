...
use DB;
class EkskulBiasaAlpa3Export implements FromCollection
{
    ...
    */
    ...
    {
        return $users = DB::table('users')->where('kehadiran_ekskul_biasa','>',3)->select('nis','nama','nama_rombel','nama_rayon','nama_ekskul_biasa','kehadiran_ekskul_biasa')
