...
use DB;
class DataSenbudExport implements FromCollection
{
    protected $id;
    ...
    */
    ...
    {
        return DB::table('users')->where("senbud_id",$this->id)->select('nis','nama','nama_jurusan','nama_rombel','nama_rayon','kelas','jk','nama_senbud')
