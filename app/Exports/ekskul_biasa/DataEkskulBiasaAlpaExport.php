...
use DB;
class DataEkskulBiasaAlpaExport implements FromCollection
{
    protected $id;
    ...
    */
    ...
    {
        return DB::table('users')->where("ekskul_biasa_id",$this->id)->where('kehadiran_ekskul_biasa','>',3)->select('nis','nama','nama_jurusan','nama_rombel','nama_rayon','kelas','jk','nama_ekskul_biasa')
