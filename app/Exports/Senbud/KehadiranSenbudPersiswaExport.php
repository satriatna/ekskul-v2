...
use DB;
class KehadiranSenbudPersiswaExport implements FromCollection
{
    protected $id;
    ...
    */
    ...
    {
        return DB::table('tb_absen_senbud')->where("users_absen_senbud_id",$this->id)->select('tgl_absen_senbud_detail','keterangan_absen_senbud','nis','nama','nama_jurusan','nama_rombel','nama_rayon','kelas','jk','nama_senbud')
