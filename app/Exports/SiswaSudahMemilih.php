...
use DB;
class SiswaSudahMemilih implements FromCollection
{
    /**
    ...
    */
    ...
    {
        return DB::table('users')->where("level","Siswa")->where('cek_pilihan','sudah')->select('nis','nama','nama_jurusan','nama_rombel','nama_rayon','kelas','jk','tgl_pilih')
