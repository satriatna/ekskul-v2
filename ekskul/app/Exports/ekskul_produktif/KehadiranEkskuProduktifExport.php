...
use DB;
class KehadiranEkskulProduktifExport implements FromCollection
{
    protected $id;
    ...
    */
    ...
    {
        return DB::table('tb_absen_ekskul_produktif')->where("tgl_absen_ekskul_produktif_detail",$this->id)->select('tgl_absen_ekskul_produktif_detail','keterangan_absen_ekskul_produktif','nis','nama','nama_jurusan','nama_rombel','nama_rayon','kelas','jk','nama_ekskul_produktif')
