...
use DB;
class DataEkskulProduktifExport implements FromCollection
{
    protected $id;
    ...
    */
    ...
    {
        return DB::table('users')->where("ekskul_produktif_id",$this->id)->select('nis','nama','nama_jurusan','nama_rombel','nama_rayon','kelas','jk','nama_ekskul_produktif')
