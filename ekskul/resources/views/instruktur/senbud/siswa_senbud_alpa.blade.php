...
@section('content')
<title>
    Filter Data Senbud {{$nama_senbud->nama_senbud}} Alpa > 3 - Aplikasi Pemilihan Senbud UPD
 </title>
  <body onload="script();">
            ...
            <div class="col-xl-4 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0"> Data Senbud : {{$nama_senbud->nama_senbud}} <br> Banyak Siswa : {{$siswa->count()}}  <br> Keterangan : Alpa > 3 <span class="text-bold" style="font-weight: bold"> </span> <br> </h5>
                      </div>
                      <div class="col-auto">
            ...
            <div class="col-xl-4 col-lg-6 mt-1">
              <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0"> <a href="/export/data_senbud_alpa/{{$nama_senbud->id_senbud}}" class="btn btn-primary btn-block">Export Excel</a> </h5>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table id="example" class="table table-striped table-bordered nowrap mt-3" style="overflow-x:auto;">
                            ...
                            <tbody>
                                ...
                                <a href="/data/senbud/siswa/{{$s->id}}/{{$s->senbud_id}}" class="btn btn-sm btn-info">Detail </a>
                                </td>
                                </tr>
                                @endforeach
                            </tfoot>
