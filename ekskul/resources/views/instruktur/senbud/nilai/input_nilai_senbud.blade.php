...
@section('content')
 ...
 <title>
    Input Nilai Senbud - Aplikasi Pemilihan Senbud UPD
 </title>
  ...
  <div class="container-fluid" style="margin-top:-60px !important;">
        ...
        <div class="card col-xl-6">
            <div class="card-body">
                <span class="mr-3" style="font-size:16px; font-weight:bold;">Input Nilai Senbud </span>
            </div>
        </div>
        ...
        Data Nama Siswa 
            ...
            <form action="/input_nilai_senbud_post" method="POST">
            ...
            {{csrf_field()}}
            <input type="hidden" value="<?php echo date('Y-m-d')?> " name="tgl_absen_senbud">
            ...
            <label for="keterangan_nilai_senbud">Keterangan Nilai</label>
            <input type="text" name="keterangan_nilai_senbud" class="form-control col-md-3" id="keterangan_nilai_senbud" placeholder="Contoh : Semester 1" required>
            </div>
