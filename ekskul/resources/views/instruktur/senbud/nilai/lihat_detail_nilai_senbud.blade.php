...
@section('content')
 ...
 <title>
    Detail Nilai Senbud {{$nama_senbud->nama_senbud}} - Aplikasi Pemilihan Senbud UPD
 </title>
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                ...
                                <a href="/export_nilai_senbud/{{$ambil->keterangan_nilai_senbud_detail}}" class="btn btn-primary btn-block">Export Excel
                  </a> 
                                </h5>
                                </div>
                                <div class="col-auto">
          ...
          <div class="card shadow">
            ...
            <table class="table table-striped table-bordered text-center" id="example"  cellspacing="0" width="100%">
                ...
                <tr class="data-row">
                    ...
                    <td class="align-middle kuota">{{$tb->nilai_pengetahuan_senbud}}</td>
