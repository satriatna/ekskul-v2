...
@section('content')
 ...
 <title>
    Detail Nilai Siswa Keputrian {{$nama_keputrian->nama_keputrian}} - Aplikasi Pemilihan keputrian UPD
 </title>
      ...
      <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white"> Nilai Siswa Keputrian : {{$nama_keputrian->nama_keputrian}} <br> Keterangan : {{$ambil->keterangan_nilai_keputrian_detail}} </span></h5>
                                </div>
                                <div class="col-auto">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                ...
                                <a href="/export_nilai_keputrian/{{$ambil->keterangan_nilai_keputrian_detail}}" class="btn btn-primary btn-block">Export Excel
                  </a> 
                                </h5>
                                </div>
                                <div class="col-auto">
        ...
        <div class="col-xl-12 mb-5 mb-xl-0">
          <div class="card shadow">
            ...
            <table class="table table-striped table-bordered text-center" id="example"  cellspacing="0" width="100%">
                ...
                @foreach($tb_nilai_keputrian as $tb)
                <tr class="data-row">
                    ...
                    <td class="align-middle kuota">{{$tb->nilai_sikap_keputrian}}</td>
                    <td class="align-middle kuota">{{$tb->nilai_pengetahuan_keputrian}}</td>
                    <td class="align-middle kuota">
                        <form action="/nilai_keputrian_ubah" method="GET">
                            <input type="hidden" name="id_nilai_keputrian" value="{{$tb->id_nilai_keputrian}}">
                            <input type="hidden" name="users_nilai_keputrian_id" value="{{$tb->users_nilai_keputrian_id}}">
