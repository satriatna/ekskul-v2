...
@section('content')
<title>
    Data Ekskul Produktif {{$ekskul_produktif->nama_ekskul_produktif}} - Aplikasi Pemilihan Senbud UPD
 </title>
  <body onload="script();">
            ...
            <div class="col-xl-4 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0"> Data Ekskul Produktif <br> <span class="text-bold" style="font-weight: bold">{{$ekskul_produktif->nama_ekskul_produktif}}  </span> <br> </h5>
                      </div>
                      <div class="col-auto">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-auto">
                          ...
                          @else
                          <input type="hidden" name="id_ekskul_produktif" value="{{$ekskul_produktif->id_ekskul_produktif}}">
            ...
            <div class="col-xl-4 col-lg-6 mt-3">
              <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0"> <a href="/kehadiran/ekskul_produktif/{{$ekskul_produktif->id_ekskul_produktif}}" class="btn btn-primary btn-block">Lihat Kehadiran</a>   </h5>
                      </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 mt-3">
              <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0"> <a href="/export/data_ekskul_produktif/{{$ekskul_produktif->id_ekskul_produktif}}" class="btn btn-primary btn-block">Export Excel</a> </h5>
                      </div>
                    </div>
