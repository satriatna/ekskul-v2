...
@section('content')
 ...
 <title>
    Input Absen Ekskul Produktif - Aplikasi Pemilihan Senbud UPD
 </title>
  ...
  <div class="container-fluid" style="margin-top:-60px !important;">
        ...
        Data Nama Siswa 
            ...
            <form action="/input/absen/ekskul_produktif" method="POST">
            {{csrf_field()}}
            ...
            <table id="example" class="table table-striped table-bordered nowrap mt-3 text-center" style="overflow-x:auto;">
                ...
                <tbody>
                    ...
                    <td class="align-middle nis">{{$s->nis}} <input name="siswa[]" type="hidden" value="{{$s->id}}">  <input type="hidden" name="ekskul_produktif_id" value="{{$ekskul_produktif->id_ekskul_produktif}}"> </td>
