      ...
      <div class="row">
         <div class="col-xl-5 order-xl-2">
          <div class="card geser">
              ...
              <div class="card-body">
                  <form method="POST" action="/data_ekskul_produktif_siswa_ubah_post">
                  {{csrf_field()}}
                  <input type="hidden" name="id_absen_ekskul_produktif" value="{{$siswa->id_absen_ekskul_produktif}}">
                  <input type="hidden" name="tgl_absen_ekskul_produktif_detail" value="{{$siswa->tgl_absen_ekskul_produktif_detail}}">
