      ...
      <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data Kehadiran Instruktur : {{$nama_instruktur->nama}} <br> Nama Ekskul Biasa : {{$nama_instruktur->nama_ekskul_biasa}} </span></h5>
                                </div>
                                <div class="col-auto">
          ...
          <div class="card shadow">
            ...
            <table class="table table-striped table-bordered" id="example"  cellspacing="0" width="100%">
                ...
                <tr class="data-row">
                    ...
                    <td class="align-middle kuota">{{$tgl->tgl_absen_instruktur_ekskul_biasa_detail}}</td>
                    <td class="align-middle kuota">{{$tgl->keterangan_absen_instruktur_ekskul_biasa}}</td>
                    @if(Auth::user()->level == "Instruktur")
                    @else
                    <td class="align-middle">
                    <a href="/data_kehadiran_instruktur_ekskul_biasa_ubah/{{$tgl->id_absen_instruktur_ekskul_biasa}}" class="btn btn-info btn-sm">Ubah</a>
                    <a href="/data_kehadiran_instruktur_ekskul_biasa_hapus/{{$tgl->id_absen_instruktur_ekskul_biasa}}" onclick="return confirm('Anda Yakin ?')" class="btn btn-danger btn-sm">Hapus</a>
                    </td>
                    @endif
                </tr>
                @endforeach
