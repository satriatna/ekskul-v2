...
<title>
    Data Ekskul Produktif {{$ekskul_produktif_siswa->nama_ekskul_produktif}}  - Aplikasi Pemilihan Senbud UPD
 </title>
<!-- Header -->
                ...
                <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data kehadiran Ekskul Produktif <span class="text-white" style="font-weight: bold">{{$ekskul_produktif_siswa->nama_ekskul_produktif}} </span></h5>
                                </div>
                                <div class="col-auto">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="{{url('/assets/img/database/'.$ekskul_produktif_siswa->foto)}}" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body">
                  <div style="overflow-x:auto;">
                      <table id="example" class="table table-striped table-bordered nowrap mt-3" style="overflow-x:auto;">
                        ...
                        <tbody>
                          @foreach($kehadiran_ekskul_produktif as $k)
                          <tr>
                              <td></td>
                              <td>{{$k->tgl_absen_ekskul_produktif_detail}}</td>
                              <td>{{$k->keterangan_absen_ekskul_produktif}}</td>
                          </tr>
                          @endforeach
                        </tfoot>
                      </table>
