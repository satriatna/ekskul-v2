...
@section('content')
<title>
    Data Siswa Non - Produktif - Aplikasi Pemilihan Senbud UPD
</title>
                ...
                <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data Ekskul Produktif : <span class="text-white" style="font-weight: bold">@foreach($siswa as $s) {{$s->nama_ekskul_produktif}} @endforeach </span></h5>
                                </div>
                                <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0 text-white">{{$absen_ekskul_produktif_hadir->count()}} </span>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0 text-white">{{$absen_ekskul_produktif_tak_hadir->count()}}</span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-white text-dark rounded-circle shadow">
