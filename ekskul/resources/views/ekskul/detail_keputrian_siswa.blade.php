...
@section('content')
<title>
    Data Siswa Seni Budaya - Aplikasi Pemilihan Keputrian UPD
</title>
                ...
                <div class="row">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Data Keputrian : <span class="text-white" style="font-weight: bold">@foreach($siswa as $s) {{$s->nama_keputrian}} @endforeach </span></h5>
                                </div>
                                <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0 text-white">{{$absen_keputrian_hadir->count()}} </span>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0 text-white">{{$absen_keputrian_tak_hadir->count()}}</span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-white text-dark rounded-circle shadow">
