      ...
      <div class="card card-profile">
        ...
        alt="User profile picture">
            ...
            <input id="upload" type="file" onchange="this.form.submit()" name="foto"/>
              <a href="" id="upload_link" class="btn btn-primary bg-gradient-primary opacity-8 text-white">Ubah Profil</a>​
            </form>
            </div>
        </div>
<br>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="number" class="form-control" id="nis" onKeyPress="if(this.value.length==8) return false;" name="nis" value="{{$p->nis}}">
                    @else
                    <input type="number" class="form-control readonly" id="nis" onKeyPress="if(this.value.length==8) return false;" name="nis" value="{{$p->nis}}" readonly>
                    @endif
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="number" class="form-control" id="nis" onKeyPress="if(this.value.length==8) return false;" name="nis" value="{{$p->nis}}">
                    @else
                    <input type="number" class="form-control" id="nis" onKeyPress="if(this.value.length==8) return false;" name="nis" value="{{$p->nis}}" disabled>
                    @endif
                  </div>
                </div>
