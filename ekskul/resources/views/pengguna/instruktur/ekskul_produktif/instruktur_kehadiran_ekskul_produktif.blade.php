...
@section('content')
<title>
    Kehadiran Instruktur Ekskul Produktif {{$ekskul_produktif->nama_ekskul_produktif}}- Aplikasi Pemilihan Senbud UPD
</title>
        ...
        <div class="col-xl-4 mb-5 mb-xl-0">
            ...
            <div class="col-xl-8 mb-5 mb-xl-0">
                <div class="card shadow-lg">
                    ...
                    Ekskul Produktif <span style="font-weight: bold">( {{$ekskul_produktif->nama_ekskul_produktif}} )</span><a class="btn btn-primary btn-sm float-right" href="/kehadiran_instruktur_ekskul_produktif/{{$ekskul_produktif->id_ekskul_produktif}}">Lihat</a>
                    </div>
