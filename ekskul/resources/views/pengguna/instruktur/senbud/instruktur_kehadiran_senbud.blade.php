...
@section('content')
<title>
    Kehadiran Instruktur Senbud {{$senbud->nama_senbud}}- Aplikasi Pemilihan Senbud UPD
</title>
        ...
        <div class="col-xl-4 mb-5 mb-xl-0">
            ...
            <div class="col-xl-8 mb-5 mb-xl-0">
                <div class="card shadow-lg">
                    ...
                    Senbud <span style="font-weight: bold">( {{$senbud->nama_senbud}} )</span><a class="btn btn-primary btn-sm float-right" href="/kehadiran_instruktur_senbud/{{$senbud->id_senbud}}">Lihat</a>
                    </div>
