...
@section('content')
<title>
    Siswa Belum Memilih - Aplikasi Pemilihan Senbud UPD
</title>
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                ...
                                Data Siswa Belum Memilih<br>
                                Banyak Siswa :  @if($siswa->count() == "") 0 @else {{$siswa->count()}} @endif <span class="text-white" style="font-weight: bold"> </span>
                                </h5>
                                </div>
                                <div class="col-auto">
                    ...
                    <!-- Card body -->
                        <div class="card-body">
                            <div class="row">
                                ...
                                @else
                                <a href="/siswa/belum_memilih_export" class="btn btn-primary btn-block">Export Excel</a>
                                @endif
