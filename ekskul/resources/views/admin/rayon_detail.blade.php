            ...
            <div class="col-xl-4 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0"> Data Siswa Rayon <br> @if($nama_rayon == '') @else {{$nama_rayon->nama_rayon}} @endif</h5>
                      </div>
                      <div class="col-auto">
          ...
          <div class="card shadow">
            ...
            <table id="example" class="table table-striped table-bordered nowrap mt-3" style="overflow-x:auto;">
                            ...
                            <tr class="data-row">
                                ...
                                <td class="align-middle word-break description2">{{$s->nama_rombel}}</td>
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="edit-modal-label">Pindah rayon</h5>
      ...
      <div class="modal-body" id="attachment-body-content">
          ...
          <div class="card">
            ...
            <div class="card-body">
            <form id="edit-form" class="form-horizontal" method="POST" action="/pindahkan/rayon">
            {{csrf_field()}}
              <!-- id -->
              ...
              <label for="dari">Dari</label>
                <input type="text" class="form-control" value="{{$nama_rayon->nama_rayon}}" readonly>
                        <br>
                        <label for="ke">Ke</label>
                             <select name="rayonAkhir" id="rayonAkhir" class="form-control">
                                 @foreach($rayon as $r)
                                 <option value="{{$r->id_rayon}}">{{$r->nama_rayon}}</option>
                                 @endforeach
                                 <option value="0">Belum Ada rayon</option>
                             </select>
                        <br>
            </div>
          </div>
